...
COPY --from=build /home/app/target/towerdefense-backend-0.0.1-SNAPSHOT.jar /usr/local/lib/towerdefense-backend.jar
EXPOSE 80
...
ENTRYPOINT /usr/local/openjdk-17/bin/java -jar /usr/local/lib/towerdefense-backend.jar \ 
